...
const height_female = svg.append('g').attr('transform','translate(100,100)');
height_male.append('line').attr('x1',0).attr('y1',100).attr('x2',161.5).attr('y2',100).style('stroke','black');
height_male.append('circle').attr('cx',161.5).attr('cy',100).attr('r',3);
height_male.append('text').attr('x',0).attr('y',120).text("台灣女生平均身高161.5cm");